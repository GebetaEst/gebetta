...
const styles = StyleSheet.create({
  verifyContainer: {
    ...
    marginHorizontal: 15,
    alignSelf: "center",
    top: height * 0.1, // Moved higher up
    height: height * 0.9, // Take more height
    width: width * 0.95, // Slightly wider
  ...
  scrollContent: {
    ...
    paddingTop: height * 0.1, // Increased from 0.05 to 0.1 (10% from top)
  ...
  logo: {
    ...
    marginBottom: 0,  // Added to remove any bottom margin
    maxWidth: 200,
    maxHeight: 200,
    alignSelf: 'center',
  },
