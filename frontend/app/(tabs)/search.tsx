...
const styles = StyleSheet.create({
  ...
  searchBarCustom: {
    ...
    height: 48,
    marginTop: 5,
    // Shadow properties to match the restaurants tab
    elevation: 3,
    shadowColor: '#000',
    shadowOffset: { width: 0, height: 2 },
    shadowOpacity: 0.1,
    shadowRadius: 4,
    // Ensures shadow follows border radius on iOS
    overflow: 'hidden',
  },
  searchIcon: {
    marginRight: 8,
  ...
  recipesList: {
    paddingHorizontal: 0, // Remove horizontal padding from the list container
    paddingVertical: 16,
  },
  columnWrapper: {
    justifyContent: 'space-between',
    marginBottom: 24,
    width: '100%',
    paddingHorizontal: 16, // This will provide equal padding on both sides
    gap: 16,
  },
  card: {
    width: '48.5%',
