...
const colors = {
  primary: "#5D4037", // Dark brown for primary elements
  background: "#FFFFFF", // White background
  text: "#5D4037", // Dark brown for regular text
  lightText: "#8D6E63", // Lighter brown for secondary text
  error: "#D32F2F", // Red for errors/delete actions
...
const styles = StyleSheet.create({
  ...
  content: {
    flex: 1,
    paddingHorizontal: 16,
    paddingBottom: 24, // Regular padding, safe area is handled by the container
  },
  emptyContainer: {
    flex: 1,
  ...
  cartItem: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: '#F5F0ED', // Light brown background
    borderRadius: 12,
    padding: 16,
    marginVertical: 8,
    borderWidth: 1,
    borderColor: '#E8E0DC', // Slightly darker border for definition
    shadowColor: 'rgba(93, 64, 55, 0.1)', // Lighter shadow with primary color tint
  ...
  footer: {
    ...
    padding: 16,
    paddingBottom: 24, // Extra padding for the bottom
    shadowColor: '#000',
    shadowOffset: { width: 0, height: -2 },
    shadowOpacity: 0.1,
    shadowRadius: 4,
  ...
  totalContainer: {
    ...
    justifyContent: 'space-between',
    alignItems: 'center',
    marginBottom: 12, // Reduce margin to lift the button
  },
  totalLabel: {
    fontSize: 16,
    fontWeight: '600',
